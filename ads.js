...
window.pauseEvent = function() {
    ...
    gameInstance.SendMessage('ButtonPause', 'OnButtonClickEvent', 'paused');
}

window.resumeEvent = function() {
    console.log("Resumeing The Game.....");
    gameInstance.SendMessage('PauseDialog', 'CloseDilogue', 'resume');
}

window.replayGameEvent = function() {
    console.log("Replaying The Game.....");
    gameInstance.SendMessage('ButtonReplay', 'ReplayGame', 'replay');
}
...
window.enableSound = function(isenabled) {
    ...
    if (isenabled)
        gameInstance.SendMessage('ButtonMusicToggle', 'OnButtonClickMusic', 'isenabled');
    else
        gameInstance.SendMessage('ButtonMusicToggle', 'OnButtonClickMusic', 'isenabled');

    if (isenabled)
        gameInstance.SendMessage('ButtonSoundToggle', 'OnButtonClickSound', 'isenabled');
    else
        gameInstance.SendMessage('ButtonSoundToggle', 'OnButtonClickSound', 'isenabled');
